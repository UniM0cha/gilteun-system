...
export default function RoleManagement() {
  const { roles, addRole, updateRole, deleteRole, isRoleInUse } = useRoleStore();
  ...
  const handleAdd = () => {
    ...
    addRole({ name: formData.name, icon: formData.icon });
  ...
  const handleUpdate = () => {
    ...
    updateRole(editingId, { name: formData.name, icon: formData.icon });
    setEditingId(null);
    setFormData({ name: "", icon: "" });
  };
