...
- [ ] 명령 히스토리 표시
- [ ] WebSocket 연동
- [ ] **E2E 테스트**: 명령 전송/수신 플로우

#### 1-2. AdminPage 구현
- [ ] 멤버 관리 탭 (온라인 상태, 권한)
- [ ] 서버 상태 모니터링 탭 (CPU, 메모리, 업타임)
- [ ] 데이터 백업/복구 탭
- [ ] 실시간 활동 로그
- [ ] **E2E 테스트**: 관리자 권한 확인, 백업/복구

#### 1-3. SettingsPage 구현
- [ ] 프로필 설정 (이름, 역할, 아이콘)
- [ ] 테마 설정 (다크모드)
- [ ] 입력 설정 (Apple Pencil 옵션)
- [ ] 위험 구역 (프로필 삭제)
- [ ] **E2E 테스트**: 설정 저장/로드
...
### 우선순위 작업 (즉시 시작)
1. **🚨 긴급**: 프로필 선택 버그 수정 및 E2E 테스트
2. **⚡ 높음**: CommandEditorPage 구현
3. **⚡ 높음**: AdminPage 멤버 관리 탭
4. **🔶 중간**: SettingsPage 프로필 설정
5. **🔶 중간**: 사이드바 네비게이션
