...
export function setupRoutes(app: Express): void {
  ...
  app.get('/api/instruments', (_req, res) => {
    const instruments = [
      ...
      { id: 'bass', name: '베이스', icon: '🎸', order_index: 2, is_active: true },
      { id: 'guitar', name: '기타', icon: '🎸', order_index: 3, is_active: true },
      { id: 'keyboard', name: '키보드', icon: '🎹', order_index: 4, is_active: true },
      { id: 'vocal', name: '보컬', icon: '🎤', order_index: 5, is_active: true },
    ];
