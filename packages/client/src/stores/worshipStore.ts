...
import type { Worship, Score } from '@gilteun/shared';
...
interface WorshipState {
  ...
  // API 호출
  fetchWorships: (date?: string) => Promise<void>;
  fetchScores: (worshipId?: string) => Promise<void>;
  fetchWorshipById: (id: string) => Promise<Worship | null>;
  
  // 초기화
  clearCurrentWorship: () => void;
}
