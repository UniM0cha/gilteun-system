...
export const FileUpload: React.FC<FileUploadProps> = ({
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      {/* 드래그앤드롭 영역 */}
      <div
        className={`relative cursor-pointer rounded-lg border-2 border-dashed p-6 text-center transition-colors duration-200 ease-in-out ${disabled ? 'cursor-not-allowed opacity-50' : 'hover:bg-gray-50'} ${
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center space-y-2">
          ...
          <p className="text-sm text-gray-600">{isDragActive ? '파일을 여기에 놓으세요' : placeholder}</p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button
                      ...
                      className="min-h-[44px] min-w-[44px] p-2 text-gray-500 hover:text-red-600"
                    >
                      <X className="h-4 w-4" />
                    </Button>
                  </div>
