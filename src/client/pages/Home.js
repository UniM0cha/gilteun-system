...
export const Home = () => {
    ...
    const [currentStep, setCurrentStep] = useState(isLoggedIn ? 'worship-select' : 'profile');
    ...
    return (<div className="min-h-screen bg-background flex items-center justify-center p-4">
      {currentStep === 'profile' && (<ProfileSelector onCreateNew={handleCreateProfile} onContinue={handleContinueWithProfile}/>)}
