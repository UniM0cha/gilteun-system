...
export const ScoreListDialog = ({
  open,
  onOpenChange,
}: ScoreListDialogProps) => {
  ...
  useEffect(() => {
    if (selectedWorshipId) {
      const worshipScores = scores.filter(
        (score) => score.worshipId === selectedWorshipId
      );
      setFilteredScores(
        worshipScores.sort((a, b) => a.orderIndex - b.orderIndex)
      );
    } else {
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            {getWorshipName(score.worshipId)}
                          </p>
                      ...
                      <div className="flex items-center space-x-2">
                        {score.filePath && (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              window.open(score.filePath, '_blank')
                            }
                          >
