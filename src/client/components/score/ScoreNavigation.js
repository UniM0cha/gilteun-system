...
export const ScoreNavigation = ({ currentPage, totalPages, onPageChange, viewport, onViewportChange, className, }) => {
      ...
      <CardContent className="p-4">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-1">
                <Input type="number" min={1} max={totalPages} value={currentPage} onChange={handlePageInput} className="w-12 h-8 text-center text-sm"/>
          ...
          <div className="space-y-2">
            ...
            return (<Button key={pageNum} variant={isActive ? 'default' : 'outline'} size="sm" onClick={() => onPageChange(pageNum)} className="h-12 text-xs">
                    {pageNum}
                  </Button>);
        })}
            </div>
