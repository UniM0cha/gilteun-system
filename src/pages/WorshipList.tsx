      ...
      <CardContent className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>{new Date(worship.date).toLocaleDateString('ko-KR', {
              year: 'numeric',
              month: 'long',
              day: 'numeric',
              weekday: 'short',
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => refetchWorships()}
                disabled={isLoadingWorships}
              >
                <RefreshCw className={`w-4 h-4 ${isLoadingWorships ? 'animate-spin' : ''}`} />
              </Button>
        ...
        <LoadingOverlay isLoading={isLoading} text="데이터를 불러오는 중...">
          <div className="space-y-6">
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">예배 목록</h2>
            ...
            {searchQuery && filteredWorships.length > 0 && (
              <p className="text-sm text-gray-600 text-center">
                {filteredWorships.length}개의 예배가 검색되었습니다
              </p>
            )}
          </div>
        </LoadingOverlay>
